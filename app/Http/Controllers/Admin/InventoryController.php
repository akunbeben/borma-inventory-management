...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $inventories = $this->inventoryRepository->paginated(10, ['products', 'products.supplier'], $searchQuery);

        return view('administrators.pages.inventory.index', compact('inventories'));
    }
