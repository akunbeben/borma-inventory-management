...
class NonFoodController extends Controller
{
    ...
    public function store(NonFoodStoreRequest $request)
    {
        ...
        return redirect(route('administrator.products.non-food.list'))->with('toast_success', 'Food Product has been added.');
    }
    ...
    public function update(NonFoodUpdateRequest $request, $uuid)
    {
        ...
        return redirect(route('administrator.products.non-food.show', $uuid))->with('toast_success', 'Food Product has been updated.');
    }
