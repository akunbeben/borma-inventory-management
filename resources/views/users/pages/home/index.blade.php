        ...
        <div class="col-4 col-md-4 col-lg-4 col-sm-12">
          <div class="card card-warning bg-secondary">
            ...
            <div class="card-footer text-right">
              <a href="{{ route('users.up-product') }}" class="card-link">Lihat <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-4 col-md-4 col-lg-4 col-sm-12">
          <div class="card card-success bg-secondary">
            ...
            <div class="card-footer text-right">
              <a href="{{ route('users.new-product') }}" class="card-link">Lihat <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-4 col-md-4 col-lg-4 col-sm-12">
          <div class="card card-danger bg-secondary">
            ...
            <div class="card-footer text-right">
              <a href="{{ route('users.prepare-product') }}" class="card-link">Lihat <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
      </div>
