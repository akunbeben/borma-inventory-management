...
<div class="main-content">
  <section class="section">
    <div class="section-header justify-content-between">
      <h1>Up Produk</h1>
      <a href="{{ route('administrator.up-product.create') }}" class="btn btn-primary"><i class="fas fa-receipt"></i> Tambahkan</a>
    </div>

    <div class="section-body">
      <h5 class="section-title">Up Produk</h5>
      <p class="section-lead">Daftar semua barang - Up Produk</p>
          ...
          <div class="card shadow card-primary">
            <div class="card-header">
              ...
              <div class="card-header-form">
                <form method="GET" action="{{ route('administrator.up-product') }}">
            ...
            <div class="card-body p-0">
              ...
              <div class="empty-state">
                ...
                <a href="{{ route('administrator.up-product.create') }}" class="btn btn-primary">Tambahkan</a>
              </div>
              @else
              <div class="table-responsive">
                <table class="table table-striped table-md table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary btn-sm" href="{{ route('administrator.up-product.edit', $product->id) }}"><i class="fas fa-edit"></i>Edit</a>
                      <button onclick="deleteConfirmation();" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Hapus</button>
                      <form id="delete-form" action="{{ route('administrator.up-product.destroy', $product->id) }}" method="POST" class="d-none">
                        @csrf
                        @method('DELETE')
                      </form>
                    </td>
