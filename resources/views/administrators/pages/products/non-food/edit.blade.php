...
<div class="main-content">
  <section class="section">
    <div class="section-header justify-content-between">
      ...
      <a href="{{ route('administrator.products.non-food.show', $product->id) }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
    </div>

    <div class="section-body">
      <h5 class="section-title">Barang - Non Food</h5>
      <p class="section-lead">Form edit barang Non Food &mdash; {{ $product->product_name }}</p>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12 col-12">
          <div class="card shadow">
            ...
            <form action="{{ route('administrator.products.non-food.update', $product->id) }}" method="post" id="form-product">
              <div class="card-body">
                @method('PUT')
                @csrf
