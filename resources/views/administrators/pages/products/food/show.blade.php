  ...
  <section class="section">
    <div class="section-header justify-content-between">
      ...
      <div class="text-right">
        <a href="{{ route('administrator.products.food.list') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
      </div>
    </div>

    <div class="section-body">
      <h5 class="section-title">Detail Barang</h5>
      <p class="section-lead">Data detail dari &mdash; {{ $product->product_name }}</p>
          ...
          <div class="card shadow">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a href="{{ route('administrator.products.food.edit', $product->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Ubah</a>
              </div>
            </div>
            <div class="card-body">
                ...
                <div class="profile-widget-header">                     
                  ...
                  <div class="profile-widget-items">
                    <div class="profile-widget-item">
                      <div class="profile-widget-item-label">Stok Aktual (Qty)</div>
