  ...
  <section class="section">
    <div class="section-header justify-content-between">
      ...
      <div class="text-right">
        ...
        <form id="delete-form" action="{{ route('administrator.products.food.destroy', $product->id) }}" method="POST" class="d-none">
          @csrf
          @method('DELETE')
        </form>
      </div>
          ...
          <div class="card shadow">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a href="{{ route('administrator.products.food.edit', $product->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
            </div>
            <div class="card-body">
